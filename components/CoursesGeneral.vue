    ...
    <div class="courses-general-container">
        <div class="courses-general-header">
            ...
            <div v-if="loadTeachers" class="courses-general-input">
                ...
                <input type="text" @input="handleFilter" placeholder="Search courses..." />
            </div>
        ...
        <div class="courses-general-app">
            ...
            <div v-if="loadTeachers" class="courses-general-app-body" v-for="(teacher,index) in filteredTeachers" :key="index">
                ...
                <div>
                    <p v-if="teacher.status == 'Completed'">Completed</p>
                    <p v-if="teacher.status == 'In progress'">In progress</p>
                </div>
                <div>
...
export default {
    ...
    setup(props) {
        ...
        const handleCoursesToEnroll = () => {
            console.log('Clicked to see all available courses')
        }
